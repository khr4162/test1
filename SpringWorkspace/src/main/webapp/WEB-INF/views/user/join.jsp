...
<h1>회원가입 페이지</h1>
<br>
<form action="/member/join" method="post" class="outbox">
...
<div class="input-group mb-3">
  ...
  <input type="password" name="pw" class="form-control" aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group mb-3">
...
<div class="input-group mb-3">
  ...
  <input type="text" name="home" class="form-control" aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group mb-3">
